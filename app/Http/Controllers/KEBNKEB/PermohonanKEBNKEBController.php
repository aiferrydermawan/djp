...
class PermohonanKEBNKEBController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'nomor_surat_wp' => ['nullable'],
            'tanggal_surat_wp' => ['nullable'],
            'nomor_lpad' => ['required'],
            'tanggal_diterima' => ['required'],
            'no_surat_pengantar_kpp' => ['nullable'],
            'tanggal_surat_pengantar' => ['nullable'],
            'tanggal_pengiriman_kpp' => ['nullable'],
            'nomor_surat_tugas' => ['nullable'],
            'tanggal_surat_tugas' => ['nullable'],
            'no_matriks' => ['nullable'],
            'tanggal_matriks' => ['nullable'],
            'nama_pk' => ['required'],

                ...
                <table class="table table-xs">
                    ...
                    @foreach($permohonan_all as $key => $item)
                        <tr wire:key="{{ $item->id }}">
                            ...
                            <td>{{ $item->penelitianFormal ? $item->penelitianFormal->status : 'Pending' }}</td>
                            <td>
                                <a class="btn btn-xs btn-warning mr-1"
                                   href="{{ route('penelitian-formal.edit',$item->id) }}">Edit</a>
                            </td>
                        </tr>
                    @endforeach
